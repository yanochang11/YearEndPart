...
def main():
    ...
    # Hidden input field that receives the value from JavaScript.
...
def handle_check_in(df, employee_row, row_index, client):
    ...
    # 【關鍵修正】: 直接從與 JS 綁定的隱藏元件讀取狀態，這是最即時的資訊來源
